...
public class UnitTask1 {
    public static void main(String[] args) {
        Scanner scan=new Scanner(System.in);
        System.out.println("Do you want to start your car?");
        boolean isStart=scan.nextBoolean(); // true===false
        ...
        System.out.println("estimatedTime is= "+estimatedTime);
        ...
        if (isStart){
            ...
            if (distance>0){
                ...
                int speedRegulator=scan.nextInt();
